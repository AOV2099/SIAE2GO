...
class DaySelectedThursday : Fragment() {
    ...
    override fun onCreateView(
        ...
        crud = SubjectCRUD(requireContext()) // AQUI IBA EL CONTEXTO THIS
        subjects =
            crud?.getSubjectsByDay(currDay.toString())// hace consulta a la deb y asigna los valores en el array
